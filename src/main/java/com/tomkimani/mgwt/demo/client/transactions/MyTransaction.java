...
public class MyTransaction extends JavaScriptObject implements Transaction {
	...
	public final native String getCustNames()/*-{
		return this.custNames;
	}-*/;

	public final native String getTransactionAmount()/*-{
		return this.transaction_amount;
	}-*/;

	public final native String getTransactionCode()/*-{
	...
	public final native String getTransactionTime()/*-{
	...
	public final native String getDisplayName()/*-{
		return this.transaction_type + " - " + "Ksh " + this.transaction_amount

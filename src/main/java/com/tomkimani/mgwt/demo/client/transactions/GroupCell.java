...
public interface GroupCell {
	...
	public class Header {
		...
		public String getDateStr() {
			return DateTimeFormat.getFormat("EEEE,dd/MM/yyyy")
					.format(getDate());
		}
	...
	public class Content {
		...
		public Content(int index, String transactionType, Double amount,
				String TransactionTime, String customerNames) {
			this.index = index;
